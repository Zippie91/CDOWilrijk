...
function PrijsBerekening() {
	...
	<?php for($i = 0; $i < sizeof($soepen); $i++){ ?>
		var val = 0;
		val = $("#aantal_soep-<?php echo $i+1; ?>").val() * <?php echo $soepen[$i]["prijs"];?>;
	...
	<?php for($i = 0; $i < sizeof($voorgerechten); $i++){ ?>
		var val = 0;
		val = $("#aantal_voorgerecht-<?php echo $i+1; ?>").val() * <?php echo $voorgerechten[$i]["prijs"];?>;
	...
	<?php for($i = 0; $i < sizeof($hoofdgerechten); $i++){ ?>
		var val = 0;
		val = $("#aantal_hoofdgerecht-<?php echo $i+1; ?>").val() * <?php echo $hoofdgerechten[$i]["prijs"];?>;
	...
	<?php for($i = 0; $i < sizeof($kindermenu); $i++){ ?>
		var val = 0;
		val = $("#aantal_kindermenu-<?php echo $i+1; ?>").val() * <?php echo $kindermenu[$i]["prijs"];?>;
	...
	<?php for($i = 0; $i < sizeof($pasta); $i++){ ?>
		var val = 0;
		val = $("#aantal_pasta-<?php echo $i+1; ?>").val() * <?php echo $pasta[$i]["prijs"];?>;
	...
	<?php for($i = 0; $i < sizeof($maaltijdsalades); $i++){ ?>
		var val = 0;
		val = $("#aantal_maaltijdsalades-<?php echo $i+1; ?>").val() * <?php echo $maaltijdsalades[$i]["prijs"];?>;
	...
	<?php for($i = 0; $i < sizeof($desserts); $i++){ ?>
		var val = 0;
		val = $("#aantal_desserts-<?php echo $i+1; ?>").val() * <?php echo $desserts[$i]["prijs"];?>;
